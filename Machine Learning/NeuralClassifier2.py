...
X1=diabetic_df2['BloodPressure']

X2=diabetic_df2['SkinThickness']


PlotGraph(X1,'X1 Blood Pressure')
PlotGraph(X2,'X2 Skin Thickness')


#PlotGraph(Y,'Y Glucose')
...
clf = MLPClassifier(solver='lbfgs', alpha=1e-5,
                     hidden_layer_sizes=(100,), random_state=1, max_iter=1000, warm_start=True)
